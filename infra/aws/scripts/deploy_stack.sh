...
required_vars=(
  ...
  COGNITIVE_PAYLOAD_ENCRYPTION_KEY
)
...
kubectl -n drovi create secret generic drovi-secrets \
  ...
  --from-literal=CONNECTOR_TOKEN_ENCRYPTION_KEY="${CONNECTOR_TOKEN_ENCRYPTION_KEY}" \
  --from-literal=CONNECTOR_TOKEN_ENCRYPTION_PREVIOUS_KEYS="${CONNECTOR_TOKEN_ENCRYPTION_PREVIOUS_KEYS:-}" \
  --from-literal=COGNITIVE_PAYLOAD_ENCRYPTION_KEY="${COGNITIVE_PAYLOAD_ENCRYPTION_KEY}" \
  --from-literal=COGNITIVE_PAYLOAD_ENCRYPTION_PREVIOUS_KEYS="${COGNITIVE_PAYLOAD_ENCRYPTION_PREVIOUS_KEYS:-}" \
