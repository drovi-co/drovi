...
function createCoreShellModule(): DroviModule {
  return {
    ...
    routes: [
      ...
      {
        id: "core.world_brain.overview",
        path: "/dashboard/world-brain/overview",
        slot: "dashboard",
        featureFlag: "world_brain",
      },
      {
        id: "core.world_brain.sources",
        path: "/dashboard/world-brain/sources",
        slot: "dashboard",
        featureFlag: "world_brain",
      },
      {
        id: "core.world_brain.tape",
        path: "/dashboard/world-brain/tape",
        slot: "dashboard",
        featureFlag: "world_brain",
      },
      {
        id: "core.world_brain.obligations",
        path: "/dashboard/world-brain/obligations",
        slot: "dashboard",
        featureFlag: "world_brain",
      },
      {
        id: "core.world_brain.counterfactuals",
        path: "/dashboard/world-brain/counterfactuals",
        slot: "dashboard",
        featureFlag: "world_brain",
      },
    ...
    navItems: [
      ...
      },
      {
        id: "core.world_brain.overview",
        label: "Overview",
        to: "/dashboard/world-brain/overview",
        group: "console",
        parentId: "core.world_brain",
        order: 1,
        requiresCapability: "world.brain.read",
      },
      {
        id: "core.world_brain.sources",
        label: "Source Ops",
        to: "/dashboard/world-brain/sources",
        group: "console",
        parentId: "core.world_brain",
        order: 2,
        requiresCapability: "world.brain.read",
